...
export abstract class AppComponentBase {
    ...
    Level = {
      ...
      userLevels = [
        ...
        { value: this.Level.Intern_600K, name: "Intern_1", style: {'background-color': '#8F9779'}},
        { value: this.Level.Intern_2M, name: "Intern_2", style: {'background-color': '#665D1E'}},
        { value: this.Level.Intern_4M, name: "Prefresher", style: {'background-color': '#4B5320'}},
